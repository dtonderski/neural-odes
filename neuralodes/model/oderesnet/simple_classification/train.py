...
from neuralodes.model.oderesnet.simple_classification.evaluation import evaluate
from neuralodes.model.oderesnet.simple_classification.loss import loss
from neuralodes.model.oderesnet.simple_classification.odenet import ODENet
from neuralodes.model.oderesnet.simple_classification.resnet import ResNet
...
def get_name(model_type, dataset, solver, width):
    return f"simple_classification_{model_type}_{dataset}_{solver}_{width}"    
