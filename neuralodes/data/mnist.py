...
def get_dataset(train: bool, root: str = "data/MNIST") -> torchvision.datasets.MNIST:
...
def get_dataloader_from_dataset(dataset: torchvision.datasets.MNIST, batch_size: int = 128) -> DataLoader:
    return DataLoader(
        dataset=dataset,
